...
@EnableJpaRepositories(repositoryFactoryBeanClass = EntityDaoFactoryBean.class, basePackages = { "com.allyes.mec.cloud.dao" })
public class JpaConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).properties(properties).packages("com.allyes.mec.cloud.entity").build();
	}
