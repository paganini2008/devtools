...
import com.github.paganini2008.springboot.fastjpa.AbstractTransformer;
import com.github.paganini2008.springboot.fastjpa.JpaAttributeDetail;
...
public class BeanTransformer<E, T> extends AbstractTransformer<E, T> {
	...
	private void initialize(Class<T> resultClass) {
		Field[] fields = FieldUtils.getFieldsWithAnnotation(resultClass, PropertyMapper.class);
