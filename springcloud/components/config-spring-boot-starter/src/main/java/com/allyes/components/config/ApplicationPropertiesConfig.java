...
import static com.allyes.components.config.ExternalConfigurationSpringApplication.CONFIGURATION_BOOT_NAME;
...
import com.allyes.developer.utils.NotImplementedException;
...
public class ApplicationPropertiesConfig implements EnvironmentAware {
	...
	@Bean(destroyMethod = "cancelIntervalRefreshing")
	...
	protected ApplicationProperties fetchGitConfigProperties() throws Exception {
		...
		configProperties.refresh(git.getRefreshingInterval());
