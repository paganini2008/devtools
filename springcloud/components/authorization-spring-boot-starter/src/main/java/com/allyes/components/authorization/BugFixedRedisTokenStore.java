package com.allyes.components.authorization;
 ...
 */
@Component
public class BugFixedRedisTokenStore implements TokenStore {
	...
	public BugFixedRedisTokenStore(RedisConnectionFactory connectionFactory) {
